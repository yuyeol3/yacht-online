...
@Repository
@ConditionalOnProperty(name = "yacht.participation-store", havingValue = "memory", matchIfMissing = true)
public class InMemoryParticipatedRepository implements ParticipatedRepository {
    ...
    public InMemoryParticipatedRepository() {
